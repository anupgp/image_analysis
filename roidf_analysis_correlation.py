...
# ---------------
omitrois2hz = ['20190418_S1E3_spine1','20190417_S2C1_spine1','20190417_S2C1_spine1']
omitrois8hz = [""]
...
sns.scatterplot(x="potency",y="delay",hue="roiid",data=prpt[prpt["stimfreq"] == stimfreq],ax=ah,s=60)
fh,ah = format_plot(fh,ah,"Potency","Delay","Potency Vs Delay at "+str(stimfreq)+"Hz")
