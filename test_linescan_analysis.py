...
fnlsts = "/Volumes/Anup_2TB/raw_data/beiquelab/zen/data_anup/20190801/S1C1S2/20hz/Image 89.czi"
fnlsls = "/Volumes/Anup_2TB/raw_data/beiquelab/zen/data_anup/20190801/S1C1S2/20hz/Image 89.czi"
...
fh1,ah1 = zeiss.display_lineselect_image(zfilelsls.attachimage,1,x1,y1,x2,y2,title=compress_filename(fnlsls,4),savepath=datasavepath)
...
zfilelsts.save_roi_to_csvfile(fname=compress_filename(fnlsts,4),savepath=datasavepath)
